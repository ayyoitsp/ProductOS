...
description: Judges whether a way of writing product truth is SUFFICIENT to express a real product and whether a human could actually review it. Reviews the framework, never whether a particular product is ready to build. Use for framework validation runs; never to author or fix a corpus.
