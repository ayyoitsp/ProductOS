---
name: productos-coverage
description: Is each defect and each behaviour pinned by something that fails on its own? Reviews only — never writes, edits or fixes anything.
